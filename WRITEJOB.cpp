...
/*OTCombo0713
            ...
            break;
*/
            case DEVICETRAFFICLIGHT:                                            //�ص{����ORS232����O
            /*
                 ucTmpLight[0] = 0x55;
                 ucTmpLight[1] = 0x55;
                 ucTmpLight[2] = 0x55;
...
//                   smem.redCountPort.Rs232Write(ucTmpLight, 10,"dev-EmptyRedCount");
            ...
            case DEVICETAINANPEOPLELIGHT:                                                //92�~���汱����
            ...
            case DEVICEREDCOUNTVERTAICHUNG:
              if(smem.TaichungRedCountPort.GetPortAlreadyOpen()){
                statusRs232 = smem.TaichungRedCountPort.Rs232Write(packet,length,"dev-RedCountTaichung");
              }else{}
            break;
