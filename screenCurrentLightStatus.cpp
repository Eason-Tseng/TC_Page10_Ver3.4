...
//  stc.Lock_to_Load_Segment_for_Panel(iCurrentSegNo);
  CSTC::Lock_to_Load_Plan_for_Panel(iCurrentPlanID);
  CSTC::Lock_to_Load_Phase_for_Panel(iCurrentPhaseID);

  int iCurrentSubphase = stc.vGetUSIData(CSTC_exec_phase_current_subphase);
  int iCurrentSubphaseTotal = CSTC::_panel_phase._subphase_count;

  int iCurrentStep     = stc.vGetUSIData(CSTC_exec_phase_current_subphase_step);
  int iCurrentStepTotal = CSTC::_panel_phase._total_step_count;
