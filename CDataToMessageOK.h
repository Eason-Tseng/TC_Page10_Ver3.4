...
//        MESSAGEOK QuerySSBasicInfo_S0(void);
    ...
    /* HowToUse _MessageOfMake = vPackageINFOTo92Protocol(Info,  Length); */
        MESSAGEOK vPackageINFOTo92Protocol(unsigned char *, int ,bool);                     /*??Info???]?? AABBooxxINFOAADDchk */
...
//        MESSAGEOK vSet92VDTransmitCycle_6F3FToMessageOK(short int,short int);
    ...
    //For Ver94RedCount
        ...
        MESSAGEOK vPackageINFOToGreenmanCount(unsigned short int ,       
                                              unsigned short int ,
       ...
       MESSAGEOK vPackageINFOToredcountTaichung(unsigned short int phase0H,  
